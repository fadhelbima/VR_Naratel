...
import borghese from "/src/Images/14.jpg";
import alps from "/src/Images/15.jpg";
...
// create the buttons
const button1 = Button.CreateSimpleButton("button1", "Alps");
button1.width = "100px";
button1.height = "40px";
button1.color = "white";
button1.thickness = 2;
...
const button2 = Button.CreateSimpleButton("button2", "Gardens");
button2.width = "100px";
button2.height = "40px";
button2.color = "white";
button2.thickness = 0;
...
var zoomInButton = Button.CreateSimpleButton("zoomInButton", "Zoom In");
...
var zoomOutButton = Button.CreateSimpleButton("zoomOutButton", "Zoom Out");
...
zoomOutButton.onPointerUpObservable.add(() => {
  camera.fov = Math.max(1, camera.fov - 0.1);
});
stackPanel.addControl(zoomOutButton);

// Create a rotation animation
let isRotationPlaying = true;
let rotationSpeed = 0.0005; // Bisa disesuaikan dengan kebutuhan

// Create the rotation button
const rotationButton = Button.CreateSimpleButton("rotationButton", "Pause");
